...
2. Run simulations: `./run_simulations.sh`
   _(This script runs each workload on an In-Order CPU `TimingSimpleCPU` and an Out-of-Order CPU `O3CPU`)_
...
Check out [REPORT.md](/REPORT.md) for an extensive architectural breakdown and analysis of the generated metrics.
